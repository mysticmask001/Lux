...
@Composable
fun RanchScreen(navController: NavHostController) {
...
//
                               ...
                               modifier = Modifier
                                   .clickable {
                                       navController.navigate(ROUTE_HOMES) {
                                           popUpTo(ROUTE_RANCH) { inclusive = true }
                                       }
                                   },
                               text = "Houses(100)"
                           )
               ...
               Card(
                   ...
                   Image(
                       painter = painterResource(id = R.drawable.property4),
                       contentDescription = "null"
                   )
...
@Composable
fun PreviewLight() {
    RanchScreen(rememberNavController())
}
